        ...
        <table style="width: 100%;">
            <tbody>
                ...
                <tr style="width: 100%; height: 50px;">
                    ...
                    <td style="width: 70%"><input id="fcmdpplgpn_api" name="fcmdpplgpn_api" type="text" value="<?php echo esc_attr(get_option('fcmdpplgpn_api')); ?>" required="required" style="width: 50%" /></td>
                </tr>
